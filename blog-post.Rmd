...
Reproducibility is one of the corner stones of the scientific process. Readers should be able to figure out how you generate the numbers (e.g., statistics and p-values) found in your manuscript, and from where are the
data points coming that are making up your plots. As analytical methods are growing more sophisticated, and data
sets are becoming larger, reproducibility is getting both more important and easier to do.

It is getting *more important* as basic data manipulations, that could be easily explained
in words in the past, are becoming too intricate to explain in details when
...
knitr. These technologies facilitate literate programming, yet they are typically
not taught as part of the traditional university curriculum, furthermore, these
...
the first time expressed that this had a certain "WOW-effect". 

In the afternoon of the second day, Hilmar introduced best
...
functions within your knitr document to automate the generation of the
intermediate datasets, figures and manuscript. While most participants have had
